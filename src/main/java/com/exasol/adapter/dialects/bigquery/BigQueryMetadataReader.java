...
public class BigQueryMetadataReader extends AbstractRemoteMetadataReader {
     ...
     */
    public BigQueryMetadataReader(final Connection connection, final AdapterProperties properties, final ExaMetadata metadata) {
        super(connection, properties, metadata);
    }

    @Override
    protected ColumnMetadataReader createColumnMetadataReader() {
        return new BigQueryColumnMetadataReader(this.connection, this.properties, this.exaMetadata, this.identifierConverter);
    }
